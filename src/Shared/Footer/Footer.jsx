...
const Footer = () => {
  return (
    <div>
      <footer className="footer footer-center p-10 bg-[#212121] text-gray-300 ">
  ...
  <aside>
    <p className="text-gray-500">Copyright © 2024 - All right reserved by Majestic Mansions Industries Ltd</p>
  </aside>
</footer>
    </div>
  );
