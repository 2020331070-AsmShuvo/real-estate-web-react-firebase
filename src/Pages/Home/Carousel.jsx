...
import mansions from "../../../public/mansions.jpeg";
import villas from "../../../public/mansions.jpeg";
...
const Carousel = () => {
    return (
          ...
          <div className="mr-20 z-10 flex items-center justify-center px-20">
            <div className="space-y-4 mt-6">
              ...
              <p className="text-gray-400">
                ...
                comfort. Our meticulously curated properties embody elegance and
                exclusivity, providing a sanctuary where every detail is crafted
                to perfection. Experience a new standard of refined living with
                Enhanced Living.
              </p>
            </div>
          </div>
        ...
        <div id="slide3" className="carousel-item relative w-full">
          <img src={islands} className="w-full" />
          <div className="banner-overlay absolute inset-0 bg-gradient-to-b from-transparent to-black"></div>
          <div className="absolute flex justify-between transform -translate-y-1/2 left-5 right-5 top-1/2">
            <a href="#slide2" className="btn btn-circle">
              ❮
          ...
          <div className="absolute top-3/4 mt-16 space-y-4 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-white text-4xl font-bold">
            ...
            <p className="text-sm text-center font-light">
              ...
              of island retreats available for rent. Immerse yourself in luxury
              and seclusion, where azure waters and pristine beaches await,
              promising an unparalleled getaway experience unlike any other
            </p>
          </div>
        </div>
        <div id="slide4" className="carousel-item relative w-full">
          <img src={beachfront} className="w-full" />
          <div className="banner-overlay absolute inset-0 bg-gradient-to-b from-transparent to-black"></div>
          ...
          <div className="absolute top-3/4 mt-16 space-y-4 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-white text-4xl font-bold">
            ...
            <p className="text-sm text-center font-light">
              ...
              luxury meets tranquility. Experience ultimate privacy and opulence
              in every corner of our meticulously crafted villas.{" "}
            </p>
          </div>
        </div>
        <div id="slide5" className="carousel-item relative w-full">
          <img src={penthouse} className="w-full" />
          <div className="banner-overlay absolute inset-0 bg-gradient-to-b from-transparent to-black"></div>
